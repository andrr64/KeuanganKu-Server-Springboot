...
public class SecurityConfig {
    ...
    /**
     * Konfigurasi utama Spring Security filter chain.
     * Di sini mengatur:
     * - Nonaktifkan CSRF karena menggunakan JWT dan stateless
     * - Session tidak dibuat, karena API stateless pakai JWT
     * - Endpoint dengan prefix /api/secure/** harus authenticated
     * - Endpoint lain boleh diakses semua (permitAll)
     * - Memasukkan JwtAuthenticationFilter sebelum filter standar UsernamePasswordAuthenticationFilter
     */
    @Bean
    ...
    /**
     * Bean PasswordEncoder untuk enkripsi password dengan BCrypt.
     * Digunakan di service ketika menyimpan password user dan memvalidasi saat login.
     */
    @Bean
